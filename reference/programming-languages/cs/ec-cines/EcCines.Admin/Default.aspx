<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="EcCines.Admin.Default" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Cines Admin</title>    
                    ...
                    <div class="ui-widget ui-widget-content ui-corner-all" id="login_admin">
                        <table>
                            <tr>
                                <td>Usuario</td>
                                <td>
                                    <asp:TextBox ID="txtUsuario" runat="server" CssClass="input_login" /></td>
                            </tr>
                            <tr>
                                <td>Contraseña</td>
                                <td>
                                    <asp:TextBox ID="txtContrasena" runat="server" TextMode="Password" CssClass="input_login" /></td>
                            </tr>
                        </table>
                        <asp:Button ID="btnAutenticar" runat="server" Text="Ingresar" OnClick="AutenticarUsuario" CssClass="btn btnHorario" />
                    </div>
                </asp:Panel>
            </div>
        </form>
