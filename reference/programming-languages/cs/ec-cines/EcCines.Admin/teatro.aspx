<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teatro.aspx.cs" Inherits="EcCines.Admin.teatro" %>
...
<body>
    <div id="Content">
        <form id="frmMaestroTeatro" runat="server" defaultbutton="btnDisableEnter">
            <div>
                <div class="head">
                    <div class="logo">
