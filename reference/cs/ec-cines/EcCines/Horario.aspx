<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Horario.aspx.cs" Inherits="EcCines.Horario" %>
    ...
    <div id="Content">
        <form id="form1" runat="server">
            ...
            <asp:UpdatePanel runat="server" ID="upPrincipal">
                <ContentTemplate>
                    <div>
                        <div id="sala_cine" class="title">Sala de Cine:&nbsp;
                                <asp:Label ID="Label2" runat="server" Text="" CssClass="titulo_sala"></asp:Label>
                        </div>
                        <div id="fecha_ppal">
